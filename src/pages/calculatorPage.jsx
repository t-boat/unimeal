...
const CalculatorPage = () => {
    ...
    const recommendation = () => {
        ...
        if (bmiValue < 18.5) {
            ...
            document.getElementById("recommendation").innerText = `To help you gain weight, focus on meals that are rich in calories, protein, and healthy fats. Here's a mix of meal ideas to get you started: <br /> <br />
                ...
                3. **Greek Yogurt with Granola and Honey**: Full-fat Greek yogurt mixed with granola, nuts, dried fruits, and a drizzle of honey. <br /> <br />
                ...
                3. **Pasta with Pesto and Chicken**: Whole-grain pasta tossed with pesto sauce, grilled chicken, and a side of garlic bread. <br /> <br />

                ### Dinner <br />
                1. **Beef Stir-Fry with Rice**: Lean beef strips stir-fried with mixed vegetables in a soy-ginger sauce, served over brown rice. <br />
                2. **Baked Sweet Potatoes with Ground Turkey**: Sweet potatoes stuffed with ground turkey, black beans, and topped with cheese and sour cream. <br />
                3. **Chicken Alfredo with Broccoli**: Whole-grain fettuccine with a creamy Alfredo sauce, grilled chicken, and steamed broccoli. <br /> <br />
                ...
                **Tips**: <br />
                ...
                These meal ideas should help you increase your calorie intake in a healthy and balanced way.`;
        }
            ...
            document.getElementById("recommendation").innerText = `For someone with a normal BMI looking to maintain a healthy weight, it's important to focus on balanced meals that provide all essential nutrients. Here are some meal ideas for each part of the day: <br /> <br />
                ...
                - **Greek Yogurt with Granola and Berries:** Choose plain Greek yogurt, add a serving of granola, and mix in fresh berries. <br />
                - **Whole-Grain Toast with Avocado and Eggs:** Top whole-grain toast with mashed avocado and a poached or scrambled egg. Add a side of fresh tomatoes or a piece of fruit. <br /> <br />

                ### Lunch <br />
                - **Grilled Chicken Salad:** Mix grilled chicken breast with a variety of leafy greens, cherry tomatoes, cucumbers, and a light vinaigrette. Add some quinoa or whole-grain bread on the side. <br />
                ...
                - **Vegetable Stir-Fry with Tofu:** Stir-fry a mix of colorful vegetables (like bell peppers, broccoli, and carrots) with tofu. Serve over brown rice or quinoa. <br /> <br />
                ...
                - **Chicken and Vegetable Stir-Fry:** Stir-fry chicken breast with a variety of vegetables (like snow peas, bell peppers, and mushrooms) in a light soy or teriyaki sauce. Serve over brown rice. <br /> <br />
            ...
            document.getElementById("recommendation").innerText = `To help burn fat while still maintaining a balanced diet, here are some meal ideas that are nutrient-dense and can support weight loss: <br /> <br />

                ### Breakfast: <br />
                1. **Omelette with Veggies and Avocado** <br />
                - 2-3 eggs (or egg whites) cooked with spinach, tomatoes, bell peppers, and mushrooms. <br />
                - A quarter of an avocado on the side. <br />
                - Serve with a small piece of whole-grain toast. <br /> <br />

                2. **Greek Yogurt with Berries and Nuts** <br />
                ...
                - Add cherry tomatoes, cucumbers, red onions, and a sprinkle of feta cheese. <br />
                ...
                - Sprinkle with fresh parsley and a squeeze of lemon juice. <br /> <br />

                ### Dinner: <br />
                1. **Salmon with Steamed Veggies** <br />
                - Grilled or baked salmon fillet. <br />
                - Serve with steamed broccoli, carrots, and asparagus. <br />
                - Add a small portion of brown rice or quinoa on the side. <br /> <br />

                2. **Turkey Stir-Fry** <br />
                - Ground turkey cooked with garlic, ginger, and low-sodium soy sauce. <br />
                - Stir-fry with a mix of veggies like bell peppers, broccoli, and snap peas. <br />
                - Serve over cauliflower rice or a small portion of brown rice. <br /> <br />
            ...
            document.getElementById("recommendation").innerText = `Here are some meal ideas that can help with weight loss while providing essential nutrients: <br /> <br />

                ### Breakfast: <br />
                1. **Oatmeal with Berries and Nuts**: <br />
                - Rolled oats cooked in water or almond milk <br />
                - Topped with fresh berries (e.g., blueberries, strawberries) <br />
                - A sprinkle of nuts (e.g., almonds, walnuts) <br /> <br />
                ...
                - Drizzle with tahini or lemon juice <br /> <br />
                ...
                ### Dinner: <br />
                1. **Baked Salmon with Asparagus**: <br />
                - Baked or grilled salmon fillet <br />
                - Steamed or roasted asparagus <br />
                - Quinoa or brown rice on the side <br /> <br />

                2. **Stir-fried Vegetables with Lean Protein**: <br />
    ...
    return (
        ...
        <div className="text-family ">
            ...
            <p className="mt-[2.5rem] mb-[1rem] text-[15pt] text-[rgba(0,0,0,0.5)] font-semibold border-y max-w-fit mx-auto">Introduction to the Body Mass Index</p>
