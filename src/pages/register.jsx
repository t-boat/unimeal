...
const Register = () => {
    ...
    const isTablet = useMediaQuery({ minWidth: 768, maxWidth: 944.9 });
    const isSmartPhone = useMediaQuery({ minWidth: 430, maxWidth: 767.9 });
    const isSmallPhone = useMediaQuery({ maxWidth: 429.9 });
        ...
        <>
                ...
                <div className="flex h-screen text-family">
                    ...
                    <div className="flex flex-[40%] justify-center items-center bg-[#DECDD1]">
                        ...
                        <div className="w-[90%] ">
                            ...
                            <p className="text-center text-[13pt] tracking-widest"> Become <span className="my-rainbow">A Better Version</span> Of Yourself</p>
                ...
                <div className="flex h-screen text-family">
                    ...
                    <div className="flex flex-[40%] justify-center items-center bg-[#DECDD1]">
                        ...
                        <div className="w-[90%] ">
                            ...
                            <p className="text-center tracking-widest"> Become <span className="my-rainbow">A Better Version</span> Of Yourself</p>
                    ...
                    <div className="flex flex-[65%] justify-center items-center">
            ...
            {isSmallPhone &&
                ...
                <div className="flex justify-center items-center h-screen">
                    ...
                    <form onSubmit={handleSubmit(postForm)} className="py-[1.5rem] px-[2rem] flex flex-col gap-[1rem]">
